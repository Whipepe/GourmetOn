...
const Contato = () => {
  return (
    <div id="contato" className="py-16 flex items-center justify-center h-screen bg-gray-200 flex-col">
      <h2 className="pb-4 text-3xl font-bold">Contato</h2>
        <h3 className="text-2xl mb-12">Conheça nossa equipe!</h3>

        <section className="flex justify-center items-stretch gap-8 flex-wrap mb-16">
