...
const Hero = () => {
  return (
    <div className="py-16 flex items-center h-screen bg-gray-200 flex-col">
        <p className="py-8 text-2xl font-bold text-black">Bem-vindo à GourmetOn!</p>    

        <img src="src\assets\pratos_hero.png" alt="Imagem de comida" className="w-full h-auto max-h-3/5 rounded-lg shadow-lg mb-8 opacity-80" />
        ...
        <button className="h-16 w-64 bg-red-900 text-white px-4 py-2 rounded-2xl hover:bg-red-800 transition-colors duration-300">
        Baixe nosso App!
      </button>
    </div>
  )
